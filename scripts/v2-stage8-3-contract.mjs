...
export const V2_STAGE8_3_TTS_MIGRATION_SHA256 =
  "ce0890a59dcf262c38894f865cb249339e95727764c6a98a58b43eba2a4c5367";
...
export function assertPinnedTtsMigration(migrationBytes) {
  const actual = sha256(migrationBytes);
  if (actual !== V2_STAGE8_3_TTS_MIGRATION_SHA256) {
    reject(
      "The TTS accounting migration does not match the pinned V2-8-3 digest",
      "V2_8_3_TTS_MIGRATION_DIGEST_MISMATCH",
    );
  }
  return actual;
}
...
function assertSafeArtifact(value) {
  ...
  if (
    ...
    value.ttsMigrationSha256 !== V2_STAGE8_3_TTS_MIGRATION_SHA256 ||

...
export function AiEnrichmentDialog({
  ...
  const createPreview = async () => {
    ...
    try {
      ...
      let nextCacheStatus: "generated" | "cached" = "generated";
      if (localPreviewEnabled) {
        ...
        nextCacheStatus = staged.cacheStatus === "cached" || fixture.cacheStatus === "cached"
          ? "cached"
          : "generated";
        ...
        nextCacheStatus = result.status === "generated" ? "generated" : "cached";
        setModelNotice(
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p id={descriptionId} className="mt-1 text-sm text-[var(--mimi-text-soft)]">
            {formalRouteEnabled ? `AI enrichment for ${item?.surfaceText ?? "this word"}` : description}
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="mt-4 rounded-md border border-[var(--mimi-border)] bg-[var(--mimi-surface-muted)] p-3">
        ...
        <p className="mt-1 text-xs leading-5 text-[var(--mimi-text-soft)]">
          {formalRouteEnabled
            ...
            : "This fixed preview checks the V2 flow. No Gemini request is made."}
        </p>

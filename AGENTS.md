...
- Canonical V2 Stage 8-3 child plan: `plan_docs/PLAN_V2_STAGE8_3_PRODUCTION_BACKUP_MIGRATION_CUTOVER.md`. Local Gate 1, separately approved Gate 0B, separately approved remote read-only Gate 2 and separately approved encrypted backup/restore Gate 3 are complete. Work is stopped at Approval Stop 3; Gate 4 and every later mutation/Production gate require fresh approval.
...
- V2 status: Stage 1 through V2-8-2.3 are complete within their approved scopes. PF-001 is `High / Closed`; PF-002 and PF-003 are `Normal / Closed by explicit acceptance`. V2-8-3 Gate 0B, local Gate 1, remote read-only Gate 2 and encrypted backup/restore Gate 3 are complete; work is stopped at Approval Stop 3. Production V1 and Neon `main` remain Schema Version 5. Gate 4 is unapproved. Accepted Motion/reduced-motion and Daily Episode/FSRS behavior remain unchanged.

...
Status: P1-G-A documentation, P1-G-B read-only Production inventory, P1-G-C-0 documentation-only decision packet, P1-G-C-1 read-only provider supplement, P1-G-C-2 evidence route decision, and P1-G-C-3 read-only Neon dashboard evidence completed on 2026-07-10 after separate explicit approvals. Existing Stage 5F / 5J / 5K / 5L / 5N and P1-F evidence confirms the Development / Preview Neon resource is operational. Stage 8.5 now closes the policy-level target strategy as one Neon project with Production `main`, non-production `staging`, and temporary logical `preview/*` children of `staging`. P1-G-C remains open for P1-G-C-4 branch/environment execution details and the remaining access / merge / deployment / first-write decisions.
...
- document P1-G-C-4 exact execution details for creating `staging` from the verified clean `main`, moving Development / Preview away from `main`, and connecting Production-only runtime variables to `main`;
...
- translate the accepted Stage 8.5 single-project topology into a P1-G-C-4 branch/environment execution decision;

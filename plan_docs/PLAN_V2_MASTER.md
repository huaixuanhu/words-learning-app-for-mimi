...
- `V2-8-3` has a canonical child plan at `plan_docs/PLAN_V2_STAGE8_3_PRODUCTION_BACKUP_MIGRATION_CUTOVER.md`. Local Gate 1 and separately approved Gate 0B are complete. Gate 1 provides exact cutover modes, old-client write rejection, dormant non-empty Schema 5 / Schema 6 clone/main tools, authenticated live Neon control-plane endpoint/branch binding before any Postgres connection, a Gate-2-owned Production-project hash pin that intentionally remains unset, a pinned `0003` SHA-256 (`ef991928d299a7dfb78483c96fcd7e6fd673a009cd31ca0f0f91c606d2128fba`), and a secret-free cutover manifest with paired rollback evidence. Gate 0B independently proves the performance artifact on protected Preview without entering Production.

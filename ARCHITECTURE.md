...
- Browser runtime state now distinguishes `postgres-production` from `postgres-preview`; local-only destructive controls stay blocked for all Postgres runtimes until Stage 6B-P1-D implements repository parity.

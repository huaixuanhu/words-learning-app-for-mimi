...
- Gate 3A–3B currently pass tool, encryption, wrong-identity, corruption, Schema 5 restore, digest parity and cleanup checks. Gate 3C–3D have not connected to Production because the implementation must first be committed as the exact clean evidence commit.

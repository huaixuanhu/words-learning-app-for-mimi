...
- Gate 3A–3B pass tool, encryption, wrong-identity, corruption, Schema 5 restore, digest parity and cleanup checks. After two safe repair checkpoints for libpq mapping and cross-timezone digest serialization, exact commit `88ddb1c2c96437ca3cc4a8f2103990ae70e79eac` passed the strengthened synthetic proof and the real Production read-only backup/isolated restore. The archive is `112,253` bytes with SHA-256 `d30950ee9aecefb2863ad6143494707dd723d8e89a50117bc0cf4b46662847a0`; source and restore combined digest both equal `6c82ba44caf462051b9579ca90f8a59994c8794649d6e871dd135cf0c23e2aa9`. Permissions, Keychain custody, secret-free evidence, clipboard clearing and temporary cleanup pass. Gate 3 is complete. Gate 4 now has a derived clone-migration/recovery contract and explicit user approval, but the first remote action is stopped until a separately approved temporary Neon API key can satisfy the existing live control-plane guard.
